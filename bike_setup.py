...
def calcola_setup_bici_corsa(cavallo, busto):
    # Calcola l'altezza della sella utilizzando la formula di Bernard Hinault
    altezza_sella = cavallo * 0.885

    # Calcola la distanza sella-manubrio basata sull'altezza del busto
    coefficiente_raggiungimento = 1.11  # Coefficiente per bici da corsa
    distanza_sella_manubrio = busto * coefficiente_raggiungimento

    # Calcola il dislivello sella-manubrio (altezza sella-manubrio) basato sulla formula di BikeItalia
...
# Stampa i risultati con descrizione dei riferimenti
