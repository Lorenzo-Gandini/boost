...
def save_summary(results, athlete_mod_uc):
    summary_data = []
...
def run_training_analysis(athlete, athlete_mod, athlete_mod_uc):
    folder_path = f"training_data/{athlete_mod}"
    ...
    summary_df = save_summary(results, athlete_mod_uc)
